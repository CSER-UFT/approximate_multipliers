...
REM
REM Generated by Vivado on Thu Dec 18 11:47:38 -0300 2025
...
echo "xvlog --incr --relax -prj sim_cla_8bit_vlog.prj"
call xvlog  --incr --relax -prj sim_cla_8bit_vlog.prj -log xvlog.log
