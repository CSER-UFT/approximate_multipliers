...
module sim_radix4_booth_16bit_exponential;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/radix4_booth_16bit_exponential.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: radix4_booth 16bit exponential");
