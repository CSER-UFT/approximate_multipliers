...
/**
 * Multiplicador Radix-4 Modificado com Perfuração de Produtos Parciais (PPP) - 8 bits
 */
module ppp_modified_radix4_8bit (
    input  [7:0] a,
    input  [7:0] b,
    output [15:0] product
);
    ...
    always @(*) begin
        ...
        for (i = 0; i < 4; i = i + 1) begin
            // Perfuração: Pula os bits de menor peso conforme i >= 1
            if (i >= 1 && i <= range_b) begin
