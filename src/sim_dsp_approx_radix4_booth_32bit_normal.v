...
module sim_dsp_approx_radix4_booth_32bit_normal;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/dsp_approx_radix4_booth_32bit_normal.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: multiplicador DSP approx radix 32bit normal");
