...
module sim_radix4_compressor_32bit_normal;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/radix4_compressor_32bit_normal.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: multiplicador radix + compressor 32bit normal");
