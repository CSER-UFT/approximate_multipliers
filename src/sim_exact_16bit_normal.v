...
module sim_exact_16bit_normal;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/exact_16bit_normal.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: multiplicador manual 16_normal");
