...
module sim_radix4_compressor_8bit;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/radix4_compressor_8bit.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: multiplicador radix + compressor 8bit");
