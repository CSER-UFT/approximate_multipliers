...
module sim_approx_radix_compressor_32bit_exponential;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/approx_radix_compressor_32bit_exponential.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: approx_radix_compressor 32bit exponential");
