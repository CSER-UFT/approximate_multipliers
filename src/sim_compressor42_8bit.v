...
module sim_compressor42_8bit;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/compressor42_8bit.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: compressor 4:2 8bit");
