...
module sim_modified_radix4_32bit_normal;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/modified_radix4_32bit_normal.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: multiplicador radix modificado 32bit normal");
