...
module sim_dsp_approx_radix4_booth_32bit_exponential;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/dsp_approx_radix4_booth_32bit_exponential.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: multiplicador com DSP approx radix 32bit exponential");
