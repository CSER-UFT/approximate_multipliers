...
module sim_approx_modified_radix4_16bit_uniform;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/approx_modified_radix4_16bit_uniform.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: approx_modified_radix4 16bit uniform");
