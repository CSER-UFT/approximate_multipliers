...
module sim_compressor42_32bit_uniform;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/compressor42_32bit_uniform.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: compressor 4:2 32bit_uniform");
