...
always @(*) begin
    ...
    // Correção para Unsigned: se o bit mais significativo de B for 1, 
    // o Booth subtraiu A*2^(N-1) erroneamente (tratou como sinal).
    // Adicionamos de volta para compensar e manter o comportamento Unsigned.
    if (b[7]) begin
