...
module sim_compressor42_32bit_exponential;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/compressor42_32bit_exponential.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: compressor 4:2 32bit_exponential");
