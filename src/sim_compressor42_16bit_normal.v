...
module sim_compressor42_16bit_normal;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/compressor42_16bit_normal.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: compressor 4:2 16bit_normal");
