...
module sim_approx_modified_radix4_32bit_exponential;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/approx_modified_radix4_32bit_exponential.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: approx_modified_radix4 32bit exponential");
