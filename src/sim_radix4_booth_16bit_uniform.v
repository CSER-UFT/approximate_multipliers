...
module sim_radix4_booth_16bit_uniform;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/radix4_16bit_uniform.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: multiplicador radix 16bit uniform");
