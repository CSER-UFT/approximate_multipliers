...
module sim_ppp_modified_radix4_32bit_uniform;
    ...
    reg [1023:0] output_file = "/home/jeova.barbosa/approximate_multipliers/resultados/ppp_modified_radix4_32bit_uniform.txt";
    ...
    initial begin
        ...
        $display("Simulação iniciada: ppp_modified_radix4 32bit uniform");
